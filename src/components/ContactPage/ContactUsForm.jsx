     ...
     className="flex flex-col gap-7">
            ...
            <div className='flex flex-col lg:flex-row gap-5'>
                ...
                <div className='flex flex-col gap-2 lg:w-[48%]'>
                    ...
                    <input type="text" name="firstname" id='firstname' placeholder='Enter your first name' className='form-style' 
                ...
                <div className='flex flex-col gap-2 lg:w-[48%]'>
                    ...
                    <input type="text" name="lastname" id='lastname' placeholder='Enter your Last name' className='form-style' 
                    {...register("lastname")}/>
